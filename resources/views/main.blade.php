                        ...
                        <div class="section">
                            @foreach ($result as $op)
                                <div style="padding: 10px; margin: 8px 0; background: #f8f9ff; border-radius: 6px;">
                                    <span class="badge badge-{{ $op['type'] }}">{{ strtoupper($op['type']) }}</span>
                                    <strong>{{ $op['from'] }}</strong> → <strong>{{ $op['to'] }}</strong>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="card" style="margin-top: 20px;">
                        ...
                        <form class="test-form" id="testForm">
                            ...
                            @foreach (array_keys($fields) as $field)
                                ...
                                <input type="number" step="any" name="{{ strtolower($field) }}"
                                    placeholder="Enter {{ $field }}" value="100">
                            @endforeach
